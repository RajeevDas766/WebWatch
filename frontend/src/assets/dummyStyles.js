...
export const brandPageStyles = {
  // Layout styles
  notFoundContainer:
    "min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-gray-50 to-amber-50",
  container: "min-h-screen flex items-center justify-center p-6 bg-gray-50",
  notFoundCard:
    "max-w-lg w-full text-center bg-white rounded-3xl shadow-xl p-10 border border-amber-300",
  notFoundTitle: "text-3xl font-bold mb-3 text-gray-800",
  notFoundText: "text-gray-600 mb-8 leading-relaxed",
 goBackButton:
  "px-7 py-3 bg-gray-600 text-white rounded-full hover:bg-amber-500 transition-all duration-300 flex items-center justify-center gap-2 mx-auto shadow-md",
  ...
  // Quantity Controls
  quantityContainer:
    "flex items-center gap-2 bg-gray-100 rounded-full px-2 py-1",
...
const cartPageStyles = {
  // Page layout
  pageContainer:
    "min-h-screen bg-gray-50 py-6 sm:py-8 md:py-10 lg:py-8 px-4 sm:px-6 md:px-8 lg:px-10",
  ...
  cartTitle:
    "text-3xl xl:pt-20 xl:ml-65 ml-5 pt-5 md:ml-15 md:pt-20 lg:ml-50 font-[pacifico] font-bold text-gray-700",
  clearCartButton:
  ...
  // Common form inputs
  inputBase:
    "w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:shadow-md focus:scale-[1.01] transition-transform duration-150",
  textareaBase:
    "w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:shadow-md focus:scale-[1.01] transition-transform duration-150 resize-y",
  selectBase:
    "w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:shadow-md focus:scale-[1.01] transition-transform duration-150",
  ...
  submitButton:
    "flex-1 bg-gradient-to-r from-gray-300 to-gray-500 text-white py-3 rounded-full cursor-pointer transition-colors",
  continueShoppingButton:
    "px-6 py-3 border border-gray-500 text-black rounded-full transition-all text-center",
...
export const ordersPageStyles = {
  pageContainer: "min-h-screen bg-gray-50 px-4 sm:px-6 py-8",
  innerContainer: "max-w-6xl mx-auto",

  /* Header */
  headerContainer: "flex items-center justify-between mb-6",
  titleContainer: "flex items-center gap-2 text-xl font-semibold text-gray-800",
  titleIcon: "w-5 h-5 text-gray-700",
  refreshButton: "text-sm px-3 py-1 border rounded-md hover:bg-gray-100",

  /* States */
  loadingText: "text-gray-500",
  errorText: "text-red-500",
  emptyStateContainer: "py-12 text-center",
  emptyStateText: "text-gray-500",

  /* Orders list */
  ordersContainer: "space-y-4",

  /* Order Card */
  orderCard: "bg-white rounded-xl border shadow-sm p-5",

  orderHeader: "flex items-start justify-between gap-4",

  orderTitle: "text-sm font-medium text-gray-700",
  orderDateContainer: "flex items-center gap-2 text-xs text-gray-500 mt-1",
  orderDateIcon: "w-4 h-4",

  /* Right side (status + actions) */
  statusAndActions: "flex items-center gap-4",

  /* Status badges */
  statusBadgeBase:
    "px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap",

  statusPending: "bg-orange-100 text-orange-600",
  statusCompleted: "bg-green-100 text-green-600",
  statusProcessing: "bg-blue-100 text-blue-600",
  statusCancelled: "bg-red-100 text-red-600",
  statusFailed: "bg-rose-100 text-rose-600",
  statusRefunded: "bg-purple-100 text-purple-600",
  statusDefault: "bg-gray-100 text-gray-600",

  /* Buttons */
  toggleButton:
    "flex items-center gap-1 text-sm text-gray-600 hover:text-black",
  toggleIcon: "w-4 h-4",

  cancelButtonBase: "text-sm",
  cancelButtonEnabled: "text-red-500 hover:text-red-600",
  cancelButtonDisabled: "text-gray-300 cursor-not-allowed",

  /* Expanded section */
  itemsGrid: "grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4",
  itemCard: "flex gap-3 border rounded-lg p-3",
  itemImage: "w-16 h-16 object-contain bg-gray-100 rounded",
  itemNoImage:
    "w-16 h-16 flex items-center justify-center bg-gray-100 rounded text-xs text-gray-400",
  itemDetails: "flex-1",
  itemName: "text-sm font-medium text-gray-700",
  itemPrice: "text-xs text-gray-500",
  itemQuantity: "text-xs text-gray-500",

  /* Delivery */
  deliveryDetailsContainer: "mt-5 border-t pt-4",
  deliveryTitle:
    "flex items-center gap-2 text-sm font-medium text-gray-700 mb-2",
  deliveryIcon: "w-4 h-4",
  deliveryGrid: "grid grid-cols-1 sm:grid-cols-2 gap-y-1 text-sm text-gray-600",
  deliveryLabel: "font-medium text-gray-700",

  /* Total */
  totalContainer: "flex items-center justify-between border-t mt-4 pt-3",
  totalLabel: "text-sm text-gray-600",
  totalAmount: "text-sm font-semibold text-gray-800",
};
...
const loginPageStyles = {
  ...
  rememberMeContainer: "flex items-center mb-6 gap-3",
...
export const navbarStyles = {
  ...
  mobileIconsContainer: "flex md:hidden items-center gap-3 ml-auto",
  mobileIconButton:
    "p-2 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center relative",
...
const testimonialPageStyles = {
  ...
  // Horizontal scroller
  scroller:
    "flex gap-8 overflow-x-auto xl:overflow-x-container pb-6 px-2 md:px-6  snap-x snap-mandatory cursor-grab",
