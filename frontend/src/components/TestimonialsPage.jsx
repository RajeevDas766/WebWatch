...
//   this all the above functions are for smooth scroll for x-axis
  return (
                    ...
                    <article key={c.id} className={testimonialPageStyles.card}>
                        ...
                        <div className={testimonialPageStyles.contentBlock}>
                            <div>
                                ...
                                <h3 className={testimonialPageStyles.cardMeta}>{c.meta}</h3>
                                <h3 className={testimonialPageStyles.cardExcerpt}>{c.excerpt}</h3>
                            </div>
                        </div>
                    </article>
                ))}
