...
export const navbarStyles = {
  ...
  // Mobile dropdown
  mobileDropdown: "absolute top-full left-0 right-0 mt-2 w-full md:hidden bg-gradient-to-r from-slate-50 to-slate-200 border border-slate-300/60 rounded-2xl shadow-lg p-4 z-50",
...
export const bookingStyles = {
  ...
  // Stats/Info Card
  infoCard: "bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-md border border-slate-200 p-5 mb-6 mt-4",
